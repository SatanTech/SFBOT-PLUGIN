...
let handler = async (m, { conn, usedPrefix, command}) => {
    ...
    if (new Date - global.db.data.users[m.sender].lastrob < 7200000) throw `⏱️Hai! Tunggu* ${msToTime(time - new Date())}* untuk mencuri lagi`
    let who
