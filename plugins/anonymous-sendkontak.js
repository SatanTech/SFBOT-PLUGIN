...
➔ Nama: ${name}`
	...
	if (other) this.sendHydrated(other, `${decor.htki} ᴀɴᴏɴʏᴍᴏᴜs ᴄʜᴀᴛs ${decor.htka}`, tks, await conn.profilePictureUrl(m.sender, 'image').catch(_ => './src/avatar_contact.png'), `wa.me/${m.sender.split`@`[0]}`, 'ᴛᴜʀɴ ᴄʜᴀᴛ ᴘᴀʀᴛɴᴇʀ', null,null, [['ʟᴇᴀᴠᴇ', '.leave'],[null,null],[null,null]], 0,  { mentionedJid: [m.sender]})
}
