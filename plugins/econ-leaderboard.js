...
▢ *TOP ${len} XP* 🧬
Anda : *${usersExp.indexOf(m.sender) + 1}* de *${usersExp.length}*
...
▢ *TOP ${len} DIAMOND💎* 
Anda : *${usersLim.indexOf(m.sender) + 1}* de *${usersLim.length}*
...
▢ *TOP ${len} TINGKAT* ⬆️
Anda : *${usersLevel.indexOf(m.sender) + 1}* de *${usersLevel.length}*
