...
└──────────────`, m)
  } else conn.reply(m.chat, `❎ Maaf, Anda tidak memiliki cukup *XP* untuk membeli *${count}* Diamond💎\n\n Anda bisa mendapatkan *XP* menggunakan perintah di menu *permainan dan ekonomi*`, m)
}
