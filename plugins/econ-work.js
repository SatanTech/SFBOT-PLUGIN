...
let handler = async (m, { conn, usedPrefix, command }) => {
  ...
  if (new Date - global.db.data.users[m.sender].lastwork < 3600000) throw `*🧘🏻‍♂️ Kamu lelah* oleh karena itu kamu harus menunggu *${msToTime(time - new Date())}* untuk kembali bekerja!`
